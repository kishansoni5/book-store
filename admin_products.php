...
if(isset($_POST['add_products_btn'])){
  ...
  if(mysqli_num_rows($select_product_name)>0){
    ...
    $add_product_query=mysqli_query($conn,"INSERT INTO `products`(name,author,price,image) VALUES ('$name','$author','$price','$image')") or die('query2 failed');
...
if(isset($_POST['update_product'])){
  ...
  mysqli_query($conn,"UPDATE `products` SET name='$update_name',author='$update_a_name',price='$update_price' WHERE id='$update_p_id'") or die('query failed');
...
<section class="admin_add_products">
  <form action="" method="post" enctype="multipart/form-data">
    <h3>Add Product</h3>
    <input type="text" name="name" class="admin_input"pattern="[A-Za-z\s.]+" title="Only letters and spaces are allowed" placeholder="Enter Product Name" required>

    <input type="text" name="author" class="admin_input" pattern="[A-Za-z\s.]+" title="Only letters and spaces are allowed"placeholder="Enter author Name" required>
...
<section class="edit_product_form">
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="update_a_name" value="<?php echo $fetch_update['author'];?>" class="admin_input update_box" required placeholder="Enter author Name">
